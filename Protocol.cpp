    ...
    case MSP_MOTOR_PINS:
      {
        ...
        #else
          // ESP32 uses LEDC channels, not Arduino PWM pins
          uint8_t esp32_pins[8] = {ESP32_MOTOR1_PIN, ESP32_MOTOR2_PIN, ESP32_MOTOR3_PIN, ESP32_MOTOR4_PIN, 0, 0, 0, 0};
          s_struct((uint8_t*)&esp32_pins,8);
        #endif
      }
      break;
    case MSP_RESET_CONF:
