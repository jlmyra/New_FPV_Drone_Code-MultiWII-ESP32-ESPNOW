// Output.cpp is for AVR boards only - ESP32 uses Output_ESP32.cpp
#if !defined(ESP32)
...
// its not possible to change a PWM output pin just by changing the order
  ...
  //uint8_t PWM_PIN[8] = {3,5,6,7,A2,12,7,11};   //use pin 6 and 5 instead of 10 and 11 - only valid for quad!
  #else
