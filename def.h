...
/**************************  ESP32 Board Definitions  ***********************************/
  ...
  // LED and Buzzer macros for ESP32
  #define LEDPIN_PINMODE             pinMode(ESP32_LED_PIN, OUTPUT);
  #define LEDPIN_TOGGLE              digitalWrite(ESP32_LED_PIN, !digitalRead(ESP32_LED_PIN));
  #define LEDPIN_ON                  digitalWrite(ESP32_LED_PIN, HIGH);
  #define LEDPIN_OFF                 digitalWrite(ESP32_LED_PIN, LOW);

  #define BUZZERPIN_PINMODE          pinMode(ESP32_BUZZER_PIN, OUTPUT);
  #define BUZZERPIN_ON               ledcWrite(ESP32_BUZZER_PIN, 128);  // 50% duty cycle (ESP32 Core 3.x uses pin number)
  #define BUZZERPIN_OFF              ledcWrite(ESP32_BUZZER_PIN, 0);
  ...
  // Battery voltage pin
  #define V_BATPIN                   ESP32_VBAT_PIN

  // I2C pullups - ESP32 has internal pullups
  #define I2C_PULLUPS_ENABLE         ;
  #define I2C_PULLUPS_DISABLE        ;

  // No PCINT on ESP32 - using ESP-NOW
  #define PCINT_PIN_COUNT            0

  // Dummy pin definitions for standard RX (not used with ESP-NOW)
  #define ROLLPIN                    0
  #define PITCHPIN                   1
  #define YAWPIN                     2
  #define THROTTLEPIN                3
  ...
  // Sensor availability (set based on config.h)
  #define GYRO                       1
  #define ACC                        1
  #define BARO                       0
  #define MAG                        0
  ...
  #define NAVCAP                     0
  #define EXTAUX                     0
  #define NAVI_VERSION               0

  // PWM Output handled by Output_ESP32.cpp
  #define NUMBER_MOTOR               4
