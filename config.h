...
//#define EXTENDED_AUX_STATES
  ...
  /**************************************************************************************/
    ...
    /******************************* nRF24L01 ****************************************/
    //#define NRF24_RX  // Commented out for ESP32 - using ESP-NOW instead

    /******************************* ESP-NOW for ESP32 ********************************/
    #define ESP_NOW_RX  // Enable ESP-NOW communication for ESP32
...
/*************************************************************************************************/
  ...
  /**************************************************************************************/
  /********              ESP32 MH ET Live MiniKit Pin Definitions      ******************/
  /**************************************************************************************/
  #if defined(ESP32)
    // I2C pins for MPU6050
    #define ESP32_I2C_SDA 21  // GPIO21 - I2C SDA
    #define ESP32_I2C_SCL 22  // GPIO22 - I2C SCL
    ...
    // Buzzer pin
    #define ESP32_BUZZER_PIN 32  // GPIO32 for buzzer

    // LED pin
    #define ESP32_LED_PIN 33  // GPIO33 - safe pin (GPIO2 is strapping pin - avoid)

    // Battery voltage monitoring (ADC)
    #define ESP32_VBAT_PIN 34  // GPIO34 (ADC1_CH6) - analog input only
  #endif
...
#define LAND_SPEED          100
  ...
  /********************************************************************/
    ...
    #define VBAT_CELLS_DIVS { 75, 122,  126, 18, 30, 37 } // divisor for proportional part according to resistors - larger value here gives smaller voltage
